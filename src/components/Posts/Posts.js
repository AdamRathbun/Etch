...
const Posts = ({ setCurrentId }) => {
    //initialize selector as a hook. now can access redux store, i.e. state. it's called state.posts b.c in src/reducers/index.js, it's the equivalent of map state to props. it's exported as posts
